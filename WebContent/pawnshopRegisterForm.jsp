							...
							<div class="form-regis">
								...
								<ul style="padding-left: 7px;">
									<li><form:input type="text" class="input-regis"
											placeholder="ชื่อโรงรับจำนำ" path="pawnshopName" /></li>
									<li><form:input type="text" class="input-regis"
											placeholder="อีเมล" path="pawnshopEmail" value="<%=email%>" />
									</li>
									<li><form:input type="password" class="input-regis"
											placeholder="รหัสผ่าน" path="pawnshopPassword"
											value="<%=pass%>" /></li>
									<li><form:input type="password" class="input-regis"
											placeholder="ยืนยันรหัสผ่าน" path="pawnshopPassword"
											value="<%=pass%>" /></li>
									<li><form:input type="text" class="input-regis"
											placeholder="เบอร์โทร" path="pawnshopTel" value="<%=tel%>" />
									</li>
									<li><form:select class="input-regis"
