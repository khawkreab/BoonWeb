				...
				<form:form method="post" action="savePost.html"
					...
					<div style="margin-bottom: 20px;">
						<div class="form-group float-left">
							<span> <img alt="user" src="img/gold.png" height="100"
								width="100"
								style="margin-bottom: 12px; border: 1px solid #c8cbcf">
							</span> <input type="file" id="file" multiple style="width: 70px;">
						</div>
						<div class="form-group-post float-left"
							style="margin-bottom: 30px;">
							<span>Post name</span> <span> <form:input
									path="pawnerPostName" class="post-name"
					...
					<div class="form-group float-left Subhead"
						...
						<div class="form-group enter-data">
							...
							<div class="dropdown ">
								<button class="dropbtn">
									Select electronic type <i class="fa fa-caret-down"
										aria-hidden="true"></i>
								</button>
								<div class="dropdown-content">
									<a href="#" onclick="openCity('TV')">TV</a> <a href="#"
										onclick="openCity('Mobile')">Mobile</a> <a href="#"
										onclick="openCity('camera')">Camera</a> <a href="#"
										onclick="openCity('laptop')">Laptop</a> <a href="#"
										onclick="openCity('other')">Other</a>
								</div>
							</div>
						</div>
						...
						<div id="TV" class="w3-container city">
							<div class="form-group float-left ">
								...
								<div class="form-group-post float-left ">
									<dt>Model</dt>
									<dt>
										<form:input path="pawnerPostModel" class="post-name"
											placeholder="" pattern="[0-9A-Za-z]{1,15}"
											required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left ">
									<dt>Serial Number</dt>
									<dt>
										<form:input path="pawnerPostSerial" class="post-name"
											placeholder="" pattern="[0-9A-Za-z]{1,15}"
											required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left">
									<dt>Size</dt>
									<dt>
										<form:input path="pawnerPostSize" class="post-name"
											placeholder=" 23.5x3cm" pattern="[0-9A-Za-z]{1,15}"
											required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left ">
									...
									<dt>
										<form:input path="pawnerPostProduction" type="date"
											class="post-name" required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left">
									<dt style="line-height: 45px;">
										<form:checkbox path="panwePostRemote" value="yes" />
										Remote control <strong>(If you have)</strong>
									</dt>
									<dt style="line-height: 5px;">
										<form:checkbox path="pawnerPostWarranty" value="yes" />
										Warranty Certificate <strong>(If you have)</strong>
									</dt>
								</div>
							</div>
						</div>
						...
						<div id="Mobile" class="w3-container city" style="display: none">
							...
							<div class="form-group float-left">
								...
								<div class="form-group-post float-left ">
									<dt>Capacity</dt>
									<dt>
										<form:input path="pawnerPostCapacity" class="post-name"
											placeholder="" pattern="[0-9A-Za-z]{1,}" required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left ">
									<dt>Year of purchase</dt>
									<dt>
										<form:input path="pawnerPostPurchase" type="date"
											class="post-name" required="required" />
									</dt>
								</div>
								<div class="form-group-post float-left">
									<dt style="line-height: 45px;">
										<form:checkbox path="pawnerPostBattery" value="yes" />
										Battery charger
									</dt>
									<dt style="line-height: 5px;">
										<form:checkbox path="pawnerPostWarranty" value="yes" />
						...
						<div id="camera" class="w3-container city" style="display: none">
							...
							<div class="form-group-post float-left ">
								...
								<dt>
									<form:input path="pawnerPostTypeCamera" class="post-name"
										placeholder=" Mirrorless / DSLR " pattern="[0-9A-Za-z]{1,15}"
										required="required" />
								</dt>
							</div>
							<div class="form-group-post float-left ">
								...
								<dt>
									<form:input path="pawnerPostModel" class="post-name"
										placeholder="" pattern="[0-9A-Za-z]{1,15}" required="required" />
								</dt>
							</div>
							<div class="form-group-post float-left ">
							...
							<div class="form-group-post float-left ">
								<dt>Type of len</dt>
								<dt>
									<form:input path="pawnerPostCameraLen" class="post-name"
										placeholder="" pattern="[0-9A-Za-z]{1,15}" required="required" />
								</dt>
							</div>
							<div class="form-group-post float-left ">
								<dt>Capacity</dt>
								<dt>
									<input path="pawnerPostCapacity" class="post-name"
										placeholder="" pattern="[0-9A-Za-z]{1,}" required="required" />
								</dt>
							</div>
							<div class="form-group-post float-left ">
								<dt>Year of purchase</dt>
								<dt>
									<input path="pawnerPostPurchase" type="date" class="post-name"
										required="required" />
								</dt>
							</div>
							<div class="form-group-post float-left">
					...
					<div class="form-group-post">
						<dt>
							<form:textarea path="pawnerPostDescription"
								class="post-description" style="max-width: 100%"
								pattern="[0-9A-Za-z]{0,}"></form:textarea>
						</dt>
