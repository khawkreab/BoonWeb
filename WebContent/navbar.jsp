			...
			<div class="header">
				...
				<div class="header-top">
					<div class="container">
						...
						%>
											<li>
												<a data-toggle="modal" data-target="#modalLogin" class="nav-link js-scroll-trigger" href="#">Login</a>
											</li>
											<li>
					...
					<div class="head-top">
						...
						<div class="col-sm-8 col-md-offset-2 h_menu4">
							<nav class="navbar nav_bottom" role="navigation">
								...
								%>
											<li>
												<a class="color" href="pawner-index.html">Home</a>
											</li>
											<li>
												<a class="color3" href="pawner-pledge.html">pledge</a>
											</li>
											<li>
												<a class="color4" href="pawner-track-pledge.html">track my pledge</a>
											</li>
											<li>
												<a class="color5" href="pawner-order.html">my order</a>
											</li>
											<!-- -------------------------------------------------------------------- -->
											<%
									} else if (session.getAttribute("userType") == "pawnShop") {
								%>
												<li>
													<a class="color" href="pawnshop-index.html">Home</a>
												</li>
												<li>
													<a class="color3" href="pawnshop-pledge-sell.html">pledge sell
													</a>
												</li>
												<li>
													<a class="color4" href="pawnshop-track-estimate.html">track my estimate</a>
												</li>
												<li>
													<a class="color5" href="pawnshop-list-post.html">my post
													</a>
												</li>
								...
								<div class="row">
									<div class="col-md-6 ">
										<div class="form-login float-left" style="margin-top: 50px;">
											<h1 style="font-size: 35px; font-weight: 500;">Welcome to BoonYoung
											</h1>
											<p class="Subhead-description" style="margin-bottom: 35px; width: 300px;">This used to enter boonyoung. Any pawnshop will be able to see your information.
											</p>
