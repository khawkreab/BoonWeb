				...
				<div class="re-contain">
					...
					<div class="form-group-post float-left">
						<div class="form-group ">
							<dt>Firstname</dt>
							<form:input path="pawnerFirstname" class="post-name"
								pattern="[A-Za-z]{1,}" required="required" />
						</div>

						<div class="form-group ">
							<dt>Lastname</dt>
							<form:input path="pawnerLastname" class="post-name"
								pattern="[A-Za-z]{1,}" required="required" />
						</div>

						<div class="form-group ">
							<dt>Password</dt>
							<form:input path="pawnerPassword" class="post-name"
								type="password" id="pass" pattern="[0-9A-Za-z]{1,}"
								required="required" />
						</div>

						<div class="form-group ">
							<dt>Confirm Password</dt>
							<input class="post-name" type="password" id="confirm"
								pattern="[0-9A-Za-z]{1,}" required="required">
						</div>

						<div class="form-group ">
							<dt>Email Address</dt>
							<form:input path="pawnerEmail" class="post-name"
					...
					<div class="form-group-post float-left" style="margin-left: 65px;">
						...
						<ul class="list-unstyled" style="line-height: 2; font-size: 22px;">
							<li><span class="fa fa-check text-success"></span> See many
								product on shop</li>
							<li><span class="fa fa-check text-success"></span> Check all
								estimate</li>
							<li><span class="fa fa-check text-success"></span> Check
								pawnshop location</li>
							<li><span class="fa fa-check text-success"></span> Create
								post unlimited</li>
