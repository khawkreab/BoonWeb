					...
					<div class="container-contact100 ">
						<div class="wrap-contact100">
							<div class="contact100-form">
								<form:form method="post" action="saveShopPost.html" id="form"
									...
									<input type="hidden" name="pawnshopPostItemType" value="Laptop" />
									...
									<div class="wrap-input100 validate-input"
										...
										<input class="input100" type="text" name="pawnshopPostSerial"
											placeholder="หมายเลขประจำเครื่อง" required="required" pattern="[a-zA-Z0-9]{1,20}"
									...
									<div class="wrap-input100  validate-input"
										...
										<input class="input100" type="text" name="pawnshopPostModel"
											placeholder="รุ่น" required="required" pattern="[a-zA-Z0-9]{1,20}" title="ห้ามใช้ อักษรพิเศษ และ ภาษาไทย"> <span class="focus-input100"></span>
									</div>
									<div class="wrap-input100 validate-input"
										style="margin-top: 15px;">
										<input class="input100" type="text"
											name="pawnshopPostTypeCamera" placeholder="ชนิดของกล้อง" required="required"  pattern="[^'@.,!#$?:^%&*+/=()\\_`{|}~-]{1,20}" title="ห้ามใช้ อักษรพิเศษ">
										<span class="focus-input100"></span>
									</div>
									<div class="wrap-input100 validate-input"
										style="margin-top: 15px;">
										<input class="input100" type="text" name="pawnshopPostCameraLen"
											placeholder="ชนิดของเลนส์" required="required" pattern="[^'@.,!#$?:^%&*+/=()\\_`{|}~-]{1,20}" title="ห้ามใช้ อักษรพิเศษ"> <span
											class="focus-input100"></span>
									</div>
									<div style="margin-top: 15px; width: 100%">
										...
										<div class="wrap-input100 validate-input"
											data-validate="Valid email is required: ex@abc.xyz">
											<input class="input100" type="date" name="pawnshopPostPurchase"
												placeholder="ปีที่ซื้อ"> <span
												class="focus-input100"></span>
										</div>
									</div>
									<!-- ------------------------upload image----------------------------  -->
									...
									<div class="wrap-input100 validate-input"
										style="margin-top: 15px;">
												<input class="input100" type="text" id="amounts" name="pawnshopPostPrice"
										...
										<ul>
											<li>
												<div style="font-size: 14.5px; font-weight: inherit;">
													<input type="checkbox" name="pawnshopPostBattery" value="yes" />
													Battery charger
												</div>
											</li>
											<li>
												<div style="font-size: 14.5px; font-weight: inherit;">
													<input type="checkbox" name="pawnshopPostWarranty"
