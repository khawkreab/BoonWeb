					...
					<div class="icon-header" style="width: 80%; margin: auto;">
						<form:form method="post" action="savePawner.html"
							...
							<ul style="padding-left: 7px;">
								...
								<li><form:input path="pawnerPhone" type="text"
										class="account-regis" placeholder="เบอร์โทรศัพท์"
										required="required" onkeyup="continueto();" /></li>
								...
								<li><form:input path="pawnerPassword" type="text"
										id="pass1" class="account-regis" placeholder="รหัสผ่าน"
										required="required" /></li>
								<li><input type="text" id="pass2" class="account-regis"
								...
								<li><form:select id="province" path="pawnerProvince"
										class="account-regis">
