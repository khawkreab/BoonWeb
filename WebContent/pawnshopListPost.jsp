					...
					<div
						...
						<div class="timeline-detail">
							...
							<div class="timeline-img">
								<img
									src="img/uploadImge/${post.pawnshopPostId.pawnshopPostPicture }" />
							</div>
							<!----- detail ------>
							<div>
		...
		<%-- <ul class="timeline">
			<c:forEach items="${pawnshopPosts}" var="postw">
				<li class="event"
					...
					</c:if> <c:forEach items="${order}" var="post">
						<c:if
							test="${post.pawnshopPostId.pawnshopPostId == postw.pawnshopPostId}">
							<c:if
								test="${post.pawnshopPostId.pawnshopPostStatus == 'coming'}">
					...
					<div class="d-flex">
						...
						<!----- image ------>
						<div class="p-2">
							<img src="img/uploadImge/${postw.pawnshopPostPicture }"
