			...
			<div class="container">
				<div class="history-main">
					<div class="d-flex history-title">
						...
						<div class="ml-auto p-2">
							<span>${order.pawnshopPostId.pawnshopId.pawnshopName }
								shop</span>
						</div>
					</div>
					<div class="history-body">
						<div class="row">
							<div class="col-sm-5">
								...
								<div class="pro-img">
									<img class="img-responsive" src="img/uploadImage/${order.pawnshopPostId.pawnshopPostPicture}" width="300" />
								</div>
							</div>
							<div class="col-sm-7">

								<span class="history-name">${order.pawnshopPostId.pawnshopPostName }
									${order.pawnshopPostId.pawnshopPostBrand }
									${order.pawnshopPostId.pawnshopPostTypeCamera }
								...
								<div class="history-detail">
									<ul>
										...
										<c:if
											test="${order.pawnshopPostId.pawnshopPostWarranty != null}">
											<li>Warranty :
												${order.pawnshopPostId.pawnshopPostWarranty}</li>
										</c:if>
										<c:if
											test="${order.pawnshopPostId.pawnshopPostPurchase != null}">
											<li>Purchase :
										...
										<c:if test="${order.pawnshopPostId.pawnshopPostCase != null}">
											...
											<c:if
												test="${order.pawnshopPostId.pawnshopPostDiamond != null}">
												<li>Diamond :
													${order.pawnshopPostId.pawnshopPostDiamond }</li>
											</c:if>
											<c:if
												test="${order.pawnshopPostId.pawnshopPostPackage != null}">
												<li>Package :
													${order.pawnshopPostId.pawnshopPostPackage }</li>
											</c:if>
										</c:if>
										...
										<c:if
											test="${order.pawnshopPostId.pawnshopPostBattery != null}">
											<li>Battery : ${order.pawnshopPostId.pawnshopPostBattery }</li>
										</c:if>

										<!-- Electronic com telephone -->
										<c:if
											test="${order.pawnshopPostId.pawnshopPostHarddisk != null}">
											<li>Harddisk :
												${order.pawnshopPostId.pawnshopPostHarddisk }</li>
										</c:if>

										<!-- Electronic tv -->
										<c:if
											test="${order.pawnshopPostId.pawnshopPostRemote != null}">
										...
										<li>Description :
											${order.pawnshopPostId.pawnshopPostDescription }</li>
										...
										<li>Pawnshop Name :<span class="badge badge-default">
												${order.pawnshopPostId.pawnshopId.pawnshopName} </span></li>
										<li>Pawnshop Address :<span class="badge badge-default">
												${order.pawnshopPostId.pawnshopId.pawnshopAddress} </span></li>
										<li>Pawnshop Mail :<span class="badge badge-default">
												${order.pawnshopPostId.pawnshopId.pawnshopEmail} </span></li>
