								...
								<c:forEach items="${estimatesApprove}" var="estimate">
									<c:if
										...
										<div class="row d-flex">
											...
											<div class="col-md-2">
												<a id="${estimate.pawnerPostId.pawnerId}"
				...
				<table
					...
					<tr class="item-row">
						...
						<td class="description"><i id="panwePostRemote"></i> <i
							...
							id="pawnerPostCase"></i> <i id="pawnerPostCategory"></i> <!-- <i id="pawnerPostDescription"></i> -->
							<i id="pawnerPostDevice"></i> <i id="pawnerPostDiamond"></i> <i
							id="pawnerPostHarddisk"></i> <i id="pawnerPostModel"></i> <i
							id="pawnerPostPackage"></i> <i id="pawnerPostProduction"></i> <i
							id="pawnerPostPure"></i> <i id="pawnerPostSerial"></i> <i
							id="pawnerPostRam"></i> <i id="pawnerPostSize"></i> <i
							id="pawnerPostTypeCamera"></i> <i id="pawnerPostWarranty"></i> <i
							id="pawnerPostWeigh"></i></td>
						<td>
							<p id="estimateDate"></p>
						</td>
