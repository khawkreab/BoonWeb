...
function showsteptype(e) {
	...
	step2 += " <input type='text' name='pawnshopPostPure' required='required' id='decimalOne' maxlenght='4'/> <br>"
	...
	step3 += "<label>ยอมรับเงือนไขการปล่อยของหลุดจำนำ</label>"
	step3 += "</div>"
	step3 += "</p>"
	...
	step2 += "<input type='text' name='pawnshopPostSerial' minlenght='12' maxlenght='22'>"
	...
	step2 += "<option>เหล็กกล้าประสมพิเศษ (Stainless Steel)</option>"
	step2 += "<option>ทองขาว (White Gold)</option>"
	step2 += "<option>ทองเหลือง (Yellow Gold)</option>"
	step2 += "<option>เซรามิก (Ceramic)</option>"
	step2 += "<option>ทองสีชมพู (Pink Gold)</option>"
	step2 += "<option>อื่นๆ</option>"
	step2 += "<option>ไม่ทราบ</option>"
	step2 += "</select>"
	step2 += "</div>"
	step2 += "</li>"
	...
	step2 += "<option>เหล็กกล้าประสมพิเศษ (Stainless Steel)</option>"
	step2 += "<option>เงิน (Silver)</option>"
	step2 += "<option>ทองคำ (Gold)</option>"
	step2 += "<option>ทองคำขาว (Platinum)</option>"
	step2 += "<option>ทองสีชมพู (Pink Gold)</option>"
	step2 += "<option>อื่นๆ</option>"
	step2 += "<option>ไม่ทราบ</option>"
	step2 += "</select>"
	...
	step2 += "<option>มีอยู่บริเวณหน้าปัด</option>"
	step2 += "<option>มีอยู่บริเวณสายรัดข้อมือ</option>"
	step2 += "<option>มีอยู่บนบริเวณตัวเลข</option>"
	step2 += "</select>"
	step2 += "</div>"
	step2 += "</li>"
