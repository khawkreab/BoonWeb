...
function showsteptype(e) {
	...
	step2 += "<select class='input100' name='pawnerPostCategory'>"
	...
	step2 += " <input type='text' name='pawnerPostPure' required='required'	id='decimalOne' maxlength='4'/> <br>"
	...
	step2 += "<option>เหล็กกล้าระสมพิเศษ (Stainless Steel)</option>"
