									...
									<div class=" form-group">
										...
										<div class="form-group float-left">
											...
											<div class="form-group-post float-left ">
												<dt>Capacity</dt>
												<dt>
													<form:input path="pawnshopPostCapacity" class="post-name" placeholder="" pattern="[0-9A-Za-z]{1,}" required="required" />
												</dt>
											</div>
											<div class="form-group-post float-left ">
												<dt>Year of purchase</dt>
												<dt>
													<form:input path="pawnshopPostPurchase" type="date" class="post-name" required="required" />
												</dt>
											</div>
											<div class="form-group-post float-left">
