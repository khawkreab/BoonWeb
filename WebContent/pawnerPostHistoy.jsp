								...
								<div class="history-main">
									...
									<div class="history-body">
										<div class="row">
											<div class="col-sm-5">
												<div class="pro-img">
													<img class="img-responsive" src="images/imageUpload/${post.pawnerPostPicture }" />
												</div>
											</div>
														...
														<div class="preview">
															<ul class="row">
																...
																<c:if test="${post.pawnerPostModel != null}">
																	...
																	<li class="col-md-6">ปีที่ซื้อสินค้า : ${post.pawnerPostPurchase }</li>
																	<li class="col-md-6">ปีที่ผลิตสินค้า : ${post.pawnerPostProduction}
																	</li>
																</c:if>
																...
																<c:if test="${post.pawnerPostHarddisk != null}">
																	<li class="col-md-6">Harddisk : ${post.pawnerPostHarddisk }</li>
																</c:if>
																...
																<c:if test="${post.pawnerPostCase != null}">
																	...
																	<li class="col-md-6">ชนิดของสายรัดข้อมือ : ${post.pawnerPostBracelet }</li>
															...
															<div id="showlist${post.pawnerPostId}" class="collapse">
																...
																<ul>
																	<c:forEach items="${estimatesList}" var="estimate">
																		<c:if test="${estimate.pawnerPostId.pawnerPostId == post.pawnerPostId }">
												...
												<div>
													...
													<div class="row">
														<div class="col-sm-6">
															...
															<p>ในนี้ใสที่อยู๋โรงรับจำนำที่ get from database
															</p>
														</div>
														<div class="col-sm-6">
															<table id="meta">
													...
													<div id="terms">
														<h5></h5>
														<p>
															<img src="img/logos/Artboard.png" style="height: 25px;" />b2pawn.com </p>
													</div>
												</div>
											</div>
											<input type="button" value="พิมใบแสดงการจำนำ" class="btn btn-success" onclick="window.print();" />
										</div>
									</c:if>
								</div>
							</div>
