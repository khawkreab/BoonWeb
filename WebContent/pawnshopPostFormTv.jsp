								...
								<div id="TV" class="w3-container city">
									<div class="form-group float-left ">
										...
										<div class="form-group-post float-left">
											<dt>Size</dt>
											<dt>
												<input name="pawnshopPostSize" class="post-name" placeholder=" 23.5x3cm" pattern="[0-9A-Za-z]{1,15}" required="required"
												/>
											</dt>
										</div>
										<div class="form-group-post float-left ">
											...
											<dt>
												<input name="pawnshopPostProduction" type="date" class="post-name" required="required" />
											</dt>
										</div>
										<div class="form-group-post float-left">
											<dt style="line-height: 45px;">
												<input type="checkbox" name="pawnshopPostRemote" value="yes" /> Remote control
											</dt>
