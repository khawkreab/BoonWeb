						...
						<div class="wrap-contact100">
							<div class="contact100-form">
								<form:form method="post" action="saveShopPost.html" id="form"
									...
									<div class="wrap-input100 validate-input"
										style="margin-top: 15px;">
										<input class="input100" type="text" id="amounts"
											placeholder="ราคาที่ต้องการขายสินค้า" required="required" title="ตัวเลข 0-9" 
											pattern="[^'a-zA-Zก-์@!#$?:^%&*+/=()\\_`{|}~-]{1,10}" name="pawnshopPostPrice">
